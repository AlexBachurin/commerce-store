...
const ProductsSort = () => {
    const { grid_view, setGridView, setListView, updateSort, filtered_products } = useFiltersContext();
    return <Wrapper>
        ...
        <form>
            ...
            <select onChange={updateSort} name="sort" id="sort" className='sort-input'>
